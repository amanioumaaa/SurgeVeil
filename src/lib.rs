...
#[derive(Debug)]
pub struct SurgeVeilProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SurgeVeilProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SurgeVeil processing");
    
    let mut processor = SurgeVeilProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SurgeVeilProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SurgeVeilProcessor::new(false);
